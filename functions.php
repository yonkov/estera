...
if (!function_exists('estera_setup')) {
 ...
 function estera_setup() {
  ...
  add_theme_support('custom-background', apply_filters('estera_custom_background_args', array(
...
function estera_content_width() {
 ...
 $GLOBALS['content_width'] = apply_filters('estera_content_width', 640);
}
...
function estera_styles_and_scripts() {
 ...
 //Theme js
 wp_enqueue_script('estera-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), ESTERA_VERSION, true);
 wp_enqueue_script('estera-dark-mode', get_template_directory_uri() . '/assets/js/toggleDarkMode.js', array(), ESTERA_VERSION, true);
 wp_enqueue_script('estera-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), ESTERA_VERSION, true);
...
function estera_fonts() {
 ...
 wp_enqueue_style('estera-custom-fonts', estera_fonts_url(), array(), null);
